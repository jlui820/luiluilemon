...
product13 = Product.create!(itemtype: 'shorts', name: "Pulse Motivation Short Sleeve", description: 'Run, train or flow. Wear this lightweight, multi-sport short for pretty much everything.', size: 'S', details: 'Designed for Training', price: 68, color: 'Heathered Smoky Red/Black')
product14 = Product.create!(itemtype: 'shorts', name: "Pulse Motivation Short Sleeve", description: 'Run, train or flow. Wear this lightweight, multi-sport short for pretty much everything.', size: 'M', details: 'Designed for Training', price: 68, color: 'Heathered Melody Light Grey/Black')
