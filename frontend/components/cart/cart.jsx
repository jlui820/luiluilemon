...
class CartItems extends React.Component {
  ...
  showLess(content) {
    if (content.length > 16) {
      return <h1 className="public-name">{content.slice(0, 16) + "..."}</h1>;
    } else {
      return <h1 className="public-name">{content}</h1>;
    }
  }
              ...
              return (
                <div className="cart-item-div">
                  ...
                  <button
                    ...
                    onClick={() =>
                      this.props.deleteCartItem(cartItem[1].deleteableId)
                    }
                  >
                    Delete Item
                  </button>
